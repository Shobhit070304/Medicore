...
import { Mail, Lock, Eye, EyeOff, LogIn, Cross } from 'lucide-react';
...
const Login = () => {
  ...
  <div className="min-h-screen bg-black flex items-center justify-center p-4">
    <div className="max-w-md w-full">
      <Link to="/" className='text-2xl flex justify-end hover:text-gray-400 cursor-pointer'>✕</Link>
      {/* Header */}
      ...
      <div className="space-y-5">
        ...
        <div className="flex justify-between items-center text-xs text-white/50 pt-2">
          ...
          <a href="#" className="hover:text-blue-300 transition-colors">Forgot password?</a>
        </div>
